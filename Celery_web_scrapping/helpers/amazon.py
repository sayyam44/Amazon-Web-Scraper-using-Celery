...
#these are the functions that scrap the data and put the data into
#the table format that will hence be used as the data to be strored in the django models
